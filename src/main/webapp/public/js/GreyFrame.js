...
//    bgIframe.style.backgroundColor = "gray";
    ...
    fgDiv.style.cssText = 'border: 1px solid #C8E4FC; ';
    ...
    titleDiv.style.cssText = 'color: #C8E4FC; background-color: #2B8AD0; text-align: center; ';
    ...
    closeSpan.style.cssText = 'color: #ffffff; text-align: center; ';
