var PGEdit_IE32_CLASSID="3BBC981C-DF1D-4F4E-A810-58DAA824A84A";
var PGEdit_IE32_CAB="PassGuardX.cab#version=1,0,0,1";
var PGEdit_IE32_EXE="PassGuardX.exe";

var PGEdit_IE64_CLASSID="3BBC981C-DF1D-4F4E-A810-58DAA824A84A";
		...
		prototype: {
			...
			getpgeHtml: function() {
				if (this.osBrowser==1 || this.osBrowser==3) {
					...
					var pgeOcx='<embed ID="' + this.settings.pgeId + '"  maxlength="'+this.settings.pgeMaxlength+'" input_2="'+this.settings.pgeEreg1+'" input_3="'+this.settings.pgeEreg2+'" edittype="'+this.settings.pgeEdittype+'" type="application/rytpay-edit" tabindex="'+this.settings.pgeTabindex+'" class="' + this.settings.pgeClass + '" ';
			...
			getDownHtml: function() {
				if (this.osBrowser==1 || this.osBrowser==3) {
					...
					return '<div id="'+this.settings.pgeId+'_down" class="'+this.settings.pgeInstallClass+'" style="text-align:center;">暂不支持此系统</div>';
				}				
			},
			load: function() {				
			...
			checkInstall: function() {
				try {
					if (this.osBrowser==1) {
						var comActiveX = new ActiveXObject("RytpayEdit.PassGuard.1"); 
					    ...
					    if(this.osBrowser==6){
					    	...
					    	var pge_info=navigator.plugins['RytpayEdit'].description;
					    }
