...
//            }
            ...
            MerRefundmentService.getRefundOBByMer(oid,mid,c_mdate,mid,call4RefundApply2)  
            ...
            MerRefundmentService.getRefundOBByTseq(tseq,call4RefundApply2);  
        } 
    }
    ...
    var call4RefundApply2 = function (RefundOB){
        ...
        dwr.util.setValues({v_refund_amt:div100(RefundOB.refundAmt),v_keshenqing:div100( RefundOB.orgAmt-RefundOB.refundAmt),v_orgAmt:div100(RefundOB.orgAmt)});
    ...
    function confirmRefund2() {
        ...
        if (window.confirm("确认提交退款吗?")) {
          ...
          MerRefundmentService.applyRefund(thisRefundOB,function a(msg){
              if (msg != undefined) {
                  alert(msg);
