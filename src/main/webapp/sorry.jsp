...
<body style="overflow-y:hidden;overflow-x:hidden">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" height="100%">
    ...
    <tr><td>
        <table background="<%= path%>/images/welcome-bg.jpg" width="100%" height="100%">
          <tr><td style="margin: 100 auto;text-align: center; font: bold 18px 宋体;color: #0066CC;vertical-align: middle">
							Sorry,您没有权限访问该资源!</td>
         </tr>
         <tr><td style="margin: 100 auto;text-align: center;vertical-align: middle;color: #0066CC;">
