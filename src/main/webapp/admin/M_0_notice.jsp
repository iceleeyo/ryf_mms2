...
com.rongyifu.mms.bean.MMSNotice n = new SysManageService().getMessageById(id);

%>
<br/><br/><br/><br/>
<h3 align="center"><span ><%= n==null ? "" : n.getTitle() %></span></h3><br/><br/>

<h4 align="left"><span  style="width: 800px; margin: 0pt auto; line-height: 24px;"><%= n==null ? "" :  n.getContent()%></span></h4><br/>
