...
%>
       ...
       <script type="text/javascript" src="../../public/js/settlement/admin_sync_settlement.js?<%=rand%>"></script>
    ...
    <table class="tableBorder" >
        <tr>
          <td class="title" colspan="6">&nbsp;商户结算单同步&nbsp;&nbsp;</td>
        </tr>
        <tr>
       ...
       <tr>
        <td class="th1" bgcolor="#D9DFEE" align="right" height="30px">结算发起日期：</td>
         ...
         <td width="10%" align="right" class="th1">&nbsp;结算同步状态：</td>
			<td align="left">&nbsp;
				<select name="liqState" id="liqState" >
				 	<option value="">全部...</option>
    ...
    <table id="detailResultList" class="tablelist tablelist2"  style="display: none;" >
     <thead>
        <tr valign="middle" class="title2">
         <th>选择</th><th>商户号</th>
          <th>商户简称</th><th>账户号</th><th>支付金额</th><th>退款金额</th><th>交易净额</th><th>系统手续费</th><th>退回商户手续费</th><th>手工调增</th><th>手工调减</th>
          <th>结算金额</th><th>结算批次号</th><th>发起日期</th> <th>结算同步状态</th><th>结算同步时间</th><th>备注</th><th sort="false">详细下载</th> </tr></thead>
