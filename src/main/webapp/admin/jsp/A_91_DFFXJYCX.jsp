    ...
    <div class="style">
        <form name="MERTLOG"  method="post" action="">
         <table width="100%"  align="left"  class="tableBorder">
            <tr><td class="title" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;代发风险交易查询&nbsp;&nbsp;
            </td></tr>
            ...
            <tr>
                ...
                <td class="th1" align="right" width="15%">商户类型：</td>
            ...
            <tr>
                <td class="th1" align="right" width="15%"><div id="ri">交易日期：</div><div id="mo" style="display: none">交易月份：</div></td>
                <td align="left" width="35%" >
                   ...
                   <div> 
                    ...
                    &nbsp;至&nbsp;<input id="edate" size="15px" name="edate" class="Wdate" type="text" disabled="disabled" /><font color="red">*</font>
                   </div>
                </td>
            ...
            <tr>     
                <td class="th1" bgcolor="#D9DFEE" align="right" width="15%">收款账号：</td>
                <td align="left"><input type="text"  name="to_acc_no" id="to_acc_no"  maxlength="32" size="20"/></td>
                 <td class="th1" bgcolor="#D9DFEE" align="right">其他条件： </td>
                  <td align="left" width="20%">
                	<select  style="width: 230px" id="other_id" name="other_id" onchange="doCheck(this.value);">
                ...
                <input type="text" id="amount_num" name="amount_num" value="" size="20" maxlength="11" disabled="disabled"/>
              <font id="unit"></font>
                </td>
            </tr>
       ...
       <table  class="tablelist tablelist2" id="dbhkTable" style="display: none;">
           ...
           <tr>
             <!-- <th>融易付流水号</th> -->
             <th>账户号</th><th>账户名称</th><th>系统订单号</th><th>交易金额(元)</th>
