    ...
    <div class="style">
        <form name="MERTLOG"  method="post" action="">
         <table width="100%"  align="left"  class="tableBorder">
            <tr><td class="title" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;代发经办&nbsp;&nbsp;</td></tr>
             <tr>
         ...
         <input type="text" id="trans_flow" name="trans_flow"   size="20" maxlength="20"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr><td class="th1" bgcolor="#D9DFEE" align="right" >交易类型：</td><td ><select style="width: 150px" id="ptype" name="ptype">
                ...
                <td class="th1" align="right" >系统订单号：</td>
                <td><input type="text" id="oid" name="oid"   size="20"/></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td colspan="4" align="center">
            		<input class="button" type="button" value = " 查  询 " onclick="queryDaiFaJingBan(1)"/>
            		<input class="button" type="button" value = " 下 载" onclick="downqueryDaiFaJingBan()"/>
            	</td>
            </tr>
        </table>
       </form>
       <table  class="tablelist tablelist2" id="fxpzTable" >
           ...
           <tr>
		    ...
		    <th>交易金额(元)</th><th>交易手续费(元)</th><th>付款金额(元)</th><th>收款银行</th><th>收款账户名</th><th>收款账号</th>
           </tr>
           </thead>
           <tbody id="resultList">
           </tbody>
       </table>
          <%@include file="DFJBOption.jsp" %>
      </div>   
    </body>
</html>
