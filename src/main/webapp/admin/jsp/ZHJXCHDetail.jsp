...
<body>
 <table id="hlogDetail_"  class="tableBorder detailBox3" style="display: none;height:10%">
  <tr><td class="th1" colspan="2">用户名</td><td colspan="2" id="trans_uid">b</td><td class="th1" colspan="2">账户号</td><td colspan="2" id="trans_aid"> b</td><td class="th1" colspan="1">账户名</td><td colspan="1" id="trans_aname">b</td></tr></tr>
				  ...
				  <tr><td class="th1" colspan="2">订单详细</td><td colspan="8" id="remark">b</td></tr>
				  <tr><td colspan="10">	<input type="hidden" id="h_oid"><input type="hidden" id="h_trans_flow">
				  <table  class="tableBorder  " style="height:10%;   ">
				             	
           
           <thead >
          
           <tr>
             <th bgcolor="#2B8AD0"  style="color: #fff">系统订单号</th><th bgcolor="#2B8AD0"  style="color: #fff">交易状态</th><th bgcolor="#2B8AD0"  style="color: #fff">审核状态</th>
