...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="init();initMinfos();">
    <div class="style">
        <form name="MERTLOG"  method="post" action="">
         <table width="100%"  align="left"  class="tableBorder">
            <tr><td class="title" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;账户流水查询&nbsp;&nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td class="th1" bgcolor="#D9DFEE" align="right" width="15%">账户号：</td>
                <td align="left" width="35%">	
            ...
            <td colspan="4" align="center" style="height: 30px">
                <input class="button" type="button" value = " 查 询 " onclick="queryJYZHLS(1);" />
                <input class="button" type="button" value= " 下载XLS " onclick = "downloadJYZHLS();"/>
            </td>
            </tr>
        </table>
       </form>
       ...
       <table  class="tablelist tablelist2" id="LSTable" style="display: none;">
           ...
           <tr>
             ...
             <th>收支标识</th><th>交易金额</th><th>交易手续费</th> <th>变动金额</th> <th>余额</th><th>电银流水号</th><th>流水来源表</th><th>简短说明</th>
           </tr>
