...
%>
        ...
        <script type="text/javascript" src="../../dwr/interface/SgDfShService.js"></script>
        ...
        <script type="text/javascript" src="../../public/js/adminAccount/admin_sgdfsh.js?<%=rand%>"></script>
    </head>
    ...
    <div class="style">
        <form name="MERTLOG"  method="post" action="">
         <table width="100%"  align="left"  class="tableBorder">
            <tr><td class="title" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;手工代付审核&nbsp;&nbsp;</td></tr>
             <tr>
       ...
       <table  class="tablelist tablelist2" id="fxpzTable" >
           <thead>
           <tr>
            <th>全选</th><th>代付流水号</th><th>交易类型</th><th>批次号</th><th>商户号</th><th>商户简称</th><th>商户订单号</th>
		    <th>支付渠道</th><th>交易金额(元)</th><th>交易手续费(元)</th><th>付款金额(元)</th><th>收款银行</th><th>收款账户名</th><th>收款账号</th><th>交易状态</th>
		    <th>失败原因</th>
           </tr>
           </thead>
           <tbody id="resultList">
