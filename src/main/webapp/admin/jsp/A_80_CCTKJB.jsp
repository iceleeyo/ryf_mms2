...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<script type="text/javascript">
			...
			function queryErrorRefund(pageNo){
			   ...
			   PrepPayService.queryErrorRefundPay(pageNo, authType, transState, bdate,edate,null,callbackFun);
			}
			//下载当天经办
			function downloadRefundHandle(){
				 dwr.engine.setAsync(false);
			 	 PrepPayService.downloadTodayRefund(function(data){dwr.engine.openInDownload(data);});
			}
			//回调函数
	    	   ...
	    	   dwr.util.removeAllRows("errorRefundList");
		             var cellFuncs = [
		              ...
		              var str="<span class='pageSum'>&nbsp;申请退款总金额：<font color='red'><b>" + div100(pageObj.sumResult.amtSum) +"</b></font>  元</span><span class='pageSum'> ";
		                   ...
		                   str+="<input value='退款经办' type='button' onclick='handlRefund(1)'/>&nbsp;&nbsp;&nbsp;&nbsp;";
		                   str+="<input value='退款撤销' type='button' onclick='handlRefund(3)'/>&nbsp;&nbsp;&nbsp;&nbsp;";
		                    
		              paginationTable(pageObj,"errorRefundList",cellFuncs,str,"queryErrorRefund");
	          }
	          //经办、撤销
	          function handlRefund(handleType){
	          		 ...
	          		 PrepPayService.handRefundPay(handleType,idArr,function(backData){
	          		 			if(backData=="ok"){
	          		 			   alert("操作成功！");
	          		 			   queryErrorRefund(1);
	          		 			}else{
    ...
    <div class="style">
         <table width="100%"  align="left"  class="tableBorder">
            <tr><td class="title" colspan="8">&nbsp;&nbsp;&nbsp;&nbsp;差错退款经办</td></tr>
            <tr>
                <td class="th1" align="right" width="17%">差错退款申请日期：</td>
            ...
            <td colspan="8" align="center" style="height: 30px">
                ...
                <input style="height: 24px;" type="button" value = "下载当天经办成功的数据 " onclick="downloadRefundHandle();" />
            </td>
            </tr>
        </table>
