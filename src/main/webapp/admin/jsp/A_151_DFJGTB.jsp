...
%>
        ...
        jQuery(document).ready(function(){
			isJGTB = true;
			setTimeout('jQuery("#tstat").val(1)',300);
		});
        </script>
    </head>
    ...
    <div class="style">
        <form id="queryForm" method="post" action="">
         <table width="100%" align="left" class="tableBorder">
            <tr>
            	<td class="title" colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;代付结果同步&nbsp;&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
            	<td colspan="6" align="center">
            		...
            		<input class="button" type="button" style="width:100px;" value = "下载XLS" onclick="downloadXls(1)"/>
            	</td>
            </tr>
        </table>
       </form>
       <table class="tablelist tablelist2" id="dfjyTable" style="display: none" >
           <thead>
           <tr>
             <th>全选</th><th>电银流水号</th><th>账户号</th><th>订单号</th><th>交易金额(元)</th><th>交易状态</th><th>交易类型</th>
             <th>交易银行</th><th>代付渠道</th><th>数据来源</th><th>系统时间</th><th>收款人账号</th><th>收款人户名</th>
           </tr>
           </thead>
           <tbody id="resultList">
           </tbody>
