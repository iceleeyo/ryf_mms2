...
<script type='text/javascript'>
	...
	if(requri!=null&&requri=="M_33_ZHCZ.jsp"){
			$("xxpz").style.display="";
		}
	MerZHService.getOrderInfoByOid(oid,flag,function(data){
		...
		$("remark").innerHTML=data[0].priv;
		MerZHService.queryRYTBankNo(function(bkno){
			if(bkno!=null){
				$("rytBkNo").innerHTML=bkno;
			}
		});
	});
	}
	...
	function uploadPZ(){
		$("xxpz").disabled="disabled";
		location.href="M_107_SCPZ.jsp";	
	}
</script>
</head>
<body onload="init();">
				...
				<td align="right">
					<table border="0" align="center" width="85%">
						<tr>
							...
							<td valign="top" align="left">
								<table class="tableBorder1">
									...
									<tr>
										<td>1、线下转账的收款账号为：<span id="rytBkNo" class="redfont"></span>。<input type="hidden" id="old_oid" value="<%=request.getParameter("oid")%>"/></td>
									</tr>
									<tr>
						...
						<tr>
							...
							<td colspan="2" align="left"><input class="button" type="button" onclick="lookInfo();" value="查看订单状态" /><input class="button"  type="button" id="xxpz" style="display: none;" onclick="uploadPZ();" value="上传线下凭证" /></td>
						</tr>
					</table>
				</td>
			</tr>
