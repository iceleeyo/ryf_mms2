...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="../../public/js/merchant/mer_scxxczpz.js?<%=rand%>"></script>
    ...
    <div class="style">
         ...
         <table width="100%"  align="left"  class="tableBorder">
            ...
            <tr>
               ...
               <select style="width: 150px" id="aid" name="aid">
                ...
                <td class="th1" bgcolor="#D9DFEE" align="right" width="12%">交易类型：</td>
                <td align="left" width="28%">
                <select style="width: 150px" id="ptype" name="ptype">
                    <option value="">请选择...</option>
                </select>
                </td>
                <td class="th1" align="right" width="13%">交易日期：</td>
       ...
       <table  class="tablelist tablelist2" id="mxTable" style="display: none;">
           <thead>
           <tr>
             <th>账户号</th><th>账户名称</th><th>交易金额(元)</th><th>交易手续费(元)</th>
             <!-- <th>结算总金额(元)</th> --><th>批次号</th><th>订单数量</th><th>付款凭证</th><th>系统日期</th>
             <th>交易类型</th><th>交易状态</th><th>操作</th><th>查看详细</th>
           </tr>
           </thead>
           <tbody id="resultList">
           </tbody>
