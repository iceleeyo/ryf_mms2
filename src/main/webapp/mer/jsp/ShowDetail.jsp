...
<body>
  ...
  <tr><td class="th1" colspan="2">用户名</td><td colspan="2" id="trans_uid"></td><td class="th1" colspan="2">账户号</td><td colspan="2" id="trans_aid"> b</td><td class="th1" colspan="1">账户名</td><td colspan="1" id="trans_aname">b</td></tr></tr>
				  <tr><td class="th1" colspan="2">订单号</td><td colspan="2" id="trans_oid">b</td><td class="th1" colspan="2" >批次号</td><td colspan="2" id="transFlow">b</td><td class="th1" colspan="1" >订单时间</td><td colspan="1" id="sys_date">b</td></tr>
				  <tr><td class="th1" colspan="2">交易金额</td><td colspan="2" id="trans_amt">b</td><td class="th1" colspan="2" >手续费</td><td colspan="2" id="trans_fee">b</td><td class="th1" colspan="1">交易状态</td><td colspan="1" id="trans_state">b</td></tr>
		...
		<table  class="tableBorder " height:10%">
           ...
           <tr>
             ...
             <th bgcolor="#2B8AD0"  style="color: #fff">收款方银行行号</th><th bgcolor="#2B8AD0"  style="color: #fff">收款方银行</th><th bgcolor="#2B8AD0"  style="color: #fff">收款账户名</th><th bgcolor="#2B8AD0"  style="color: #fff">收款账号</th>
             <!-- <th bgcolor="#2B8AD0"  style="color: #fff">批次号</th> -->
             <!-- 
             <th>融易付流水号</th>
              -->
           </tr>
