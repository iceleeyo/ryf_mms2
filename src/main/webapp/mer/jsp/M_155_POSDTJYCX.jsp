    ...
    <div class="style">
        <form name="queryForm">
         <table width="100%"  align="left"  class="tableBorder">
            ...
            <tr>
                <!-- <td class="th1" bgcolor="#D9DFEE" align="right" width="10%">电银流水号：</td>
                <td align="left" width="20%">
                	<input type="text" id="tseq" name="tseq" maxlength="30"/>
                </td>   -->
                <td class="th1" bgcolor="#D9DFEE" align="right">商户订单号： </td>
                <td align="left"> <input type="text" id="oid" name="oid"  maxlength="30"/></td>
                <!-- <td class="th1" bgcolor="#D9DFEE" align="right" width="10%">银联参考号：</td> -->
               
               <!--  <td align="left" width="20%">
                	<input type="text" id="bkseq" name="bkseq" maxlength="30" onchange="onlyNu(this)" onkeyup="onlyNu(this)"/>
                </td> -->
            ...
            <tr>
                ...
                <!--  <td class="th1" align="right">银行卡号：</td>
                <td align="left"> 
               		<input type="text" id="bankCardNo" name="bankCardNo" maxlength="30" onchange="onlyNu(this)" onkeyup="onlyNu(this)"/>
           		</td>  -->
       ...
       <table  class="tablelist tablelist2"  id="merTodayTable" style="display:none;">
           ...
           <tr>
            <!--  <th>电银交易编号</th><th>电银商户号</th>
             <th>电银终端号</th><th>商户简称</th>
             <th>商户订单号</th><th>交易类型</th>
             <th>交易金额(元)</th><th>交易状态</th>
             <th>银行卡号</th><th>系统时间</th>
             <th>电银流水号</th><th>终端编号</th>
             <th>手机/电话/用户/apn</th><th>银联参考号</th>
             <th>银行手续费</th><th>授权码</th>
             <th>失败原因</th> -->
             <th>电银交易编号</th><th>电银商户号</th>
             <th>电银终端号</th>
             <th>商户订单号</th><th>交易类型</th>
