 ...
 *
 */
public class AlipaySHRefund implements IOnlineRefund {
    public static final String BANK_MERID = "2088901677635530";// 支付宝的ID
		...
		public OnlineRefundBean executeRefund(Object obj) {		
			...
			try {
				Base64.encode(requestParaMap.toString());
				String repose =RefundUtil.requestByPostwithURL(requestParaMap, url);
				LogUtil.printInfoLog("AlipaySHRefund", "alipay rerutn result ", repose);
