...
public class TlogBean implements ISqlBean{
	...
	private Integer againPay_status;//再次发起状态
	private Integer againPay_date;//再次发起日期
	
	@Override
	public String getTableName() {
		return Constant.TLOG;
	}
